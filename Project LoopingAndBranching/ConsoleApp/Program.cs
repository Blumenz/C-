...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int y = 0; y < maxPets; y++)
            {
                if (ourAnimals[y, 0] != "ID #: ")
                {
                    petCount += 1;
            ...
            for (int j = 0; j <= petCount; j++)
            {
                ...
                if (ourAnimals[j, 2] != "Age: " && ourAnimals[j, 4] != "Physical description: ")
                {
                    counterA++;
                    
                    if (counterA == petCount)
                    {
        ...
        case "4":
            ...
            for (int j = 0; j <= petCount; j++)
            {
                ...
                if (ourAnimals[j, 3] != "Nickname: " && ourAnimals[j, 5] != "Personality: ")
                {
                    counterB++;

                    if (counterB == petCount)
                    {
                ...
                for (int i = 0; i < maxPets; i++)
                {
                    ...
                    if (ourAnimals[i, 3] == "Nickname: ")
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"New Nickname for {ourAnimals[i, 0]} is {ourAnimals[i, 3]}");
                            entryValid = true;
                    ...
                    if (ourAnimals[i, 5] == "Personality: ")
                    {
                        ...
                        ourAnimals[i, 5] = "Personality: " + personalityDesc;
                        Console.WriteLine($"New personality for {ourAnimals[i, 0]} is {ourAnimals[i, 5]}");
                        break;
                    }
